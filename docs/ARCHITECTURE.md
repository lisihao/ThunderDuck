...
ThunderDuck 是一个专为 Apple Silicon M4 芯片优化的高性能 OLAP (在线分析处理) 算子后端。它通过深度利用 ARM Neon SIMD、M4 缓存架构和硬件加速器，实现比 DuckDB 更快的数据分析性能。
...
│  │                      Operator Layer                               │  │
│  │  ┌────────────────────────────────────────────────────────────┐  │  │
│  │  │                  SIMD Operator Implementations              │  │  │
│  │  │                                                             │  │  │
│  │  │  ┌─────────────┐ ┌─────────────┐ ┌─────────────────────┐  │  │  │
│  │  │  │ filter_v3   │ │ aggregate_v2│ │ hash_join_v3        │  │  │  │
│  │  │  │ • count_v3  │ │ • sum_v2    │ │ • SOA HashTable     │  │  │  │
│  │  │  │ • bitmap    │ │ • minmax    │ │ • Perfect Hash      │  │  │  │
│  │  │  │ • range_v3  │ │ • avg       │ │ • Radix Partition   │  │  │  │
│  │  │  └─────────────┘ └─────────────┘ └─────────────────────┘  │  │  │
│  │  │                                                             │  │  │
│  │  │  ┌─────────────┐ ┌─────────────┐                          │  │  │
│  │  │  │ sort_v2     │ │ topk_v3     │                          │  │  │
...
│  │                      Core Layer                                   │  │
│  │  ┌─────────────────┐ ┌─────────────────┐ ┌───────────────────┐  │  │
│  │  │ Memory Manager  │ │ SIMD Primitives │ │ Platform Detect   │  │  │
│  │  │ • aligned_alloc │ │ • ARM Neon      │ │ • M4 detection    │  │  │
│  │  │ • memory_pool   │ │ • CRC32         │ │ • cache info      │  │  │
│  │  │ • cache_align   │ │ • prefetch      │ │ • core count      │  │  │
│  │  └─────────────────┘ └─────────────────┘ └───────────────────┘  │  │
│  └──────────────────────────────────────────────────────────────────┘  │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
